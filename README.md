...
- **Form tambah tugas** lengkap dengan:
  ...
  - Estimasi jumlah sesi Pomodoro (1–10 sesi)
...
- **Tombol ▶ Focus** per tugas — langsung menghubungkan ke Focus Timer
...
- Klik **▶ Focus** untuk langsung memulai sesi timer di tugas tersebut
...
1. Atur durasi sesi dengan tombol **−** dan **+** (default: 25 menit)
